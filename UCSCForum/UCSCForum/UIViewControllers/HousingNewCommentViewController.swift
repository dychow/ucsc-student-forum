//
//  HousingNewCommentViewController.swift
//  UCSCForum
//
...
class HousingNewCommentViewController: UIViewController, UITextFieldDelegate, UITextViewDelegate {

    var dataNode :HousingDataStructures.Node?
    ...
    func postComment(){
        ...
        ref = Database.database().reference().child("housing").child((dataNode?.getKey)!).child("comments")
